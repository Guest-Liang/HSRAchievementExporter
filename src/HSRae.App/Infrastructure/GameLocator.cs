...
namespace HSRae.App.Infrastructure;

internal static class GameLocator
{
    private const string RegistryPath = @"Software\miHoYo\HYP\1_1\hkrpg_cn";
    private const string InstallPathValue = "GameInstallPath";
    private const string GameExecutableName = "StarRail.exe";
    ...
    public static string ResolveChinaGameExecutable(string configuredPath)
    {
        ...
        {
            throw new ArgumentException("--game 后必须提供游戏目录或 StarRail.exe 路径", nameof(configuredPath));
        }
